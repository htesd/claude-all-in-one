...
const zh = {
  ...
  'keys.create.customRule': '8–128 个可见 ASCII 字符，不含空格',
  ...
  'keys.error.invalidKey': 'Key 格式不合法：需 8–128 个可见 ASCII 字符（不含空格）',
  'table.byModel': '按模型统计',
...
const en: Record<I18nKey, string> = {
  ...
  'keys.create.customRule': '8–128 visible ASCII characters, no spaces',
  ...
  'keys.error.invalidKey': 'Invalid key: must be 8–128 visible ASCII characters (no spaces)',
